...
int main(int argc, char**argv){
	...
	if(pid1==0){
		...
		printf("Child1 fib = %d \n Child1 RealTime=%ld sec : %ld msec\n",fib,cl_real_secs + 9 -cl_realt.it_value.tv_sec,999999-cl_realt.it_value.tv_usec/1000);
		getitimer(ITIMER_VIRTUAL,&c1_virtt);
		printf("Child1 fib = %d \n Child1 VirtualTime=%ld sec : %ld msec\n",fib,c1_virtual_secs + 9 -cl_virtt.it_value.tv_sec,999999-cl_virtt.it_value.tv_usec/1000);
		getitimer(ITIMER_PROF,&c1_virtt);
		printf("Child1 fib = %d \n Child1 ProfTime=%ld sec : %ld msec\n",fib,c1_prof_secs + 9 -cl_proft.it_value.tv_sec,999999-cl_proft.it_value.tv_usec/1000);
